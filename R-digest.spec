...
Version  : 0.6.36
Release  : 122
URL      : https://cran.r-project.org/src/contrib/digest_0.6.36.tar.gz
Source0  : https://cran.r-project.org/src/contrib/digest_0.6.36.tar.gz
...
%setup -q -n digest
pushd ..
cp -a digest buildavx2
popd
pushd ..
cp -a digest buildavx512
popd
pushd ..
cp -a digest buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719252165
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/digest/libs/digest.so
/V4/usr/lib64/R/library/digest/libs/digest.so
/VA/usr/lib64/R/library/digest/libs/digest.so
