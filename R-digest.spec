...
Version  : 0.6.14
Release  : 47
URL      : https://cran.r-project.org/src/contrib/digest_0.6.14.tar.gz
Source0  : https://cran.r-project.org/src/contrib/digest_0.6.14.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1516021344
