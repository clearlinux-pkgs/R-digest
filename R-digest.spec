...
Version  : 0.6.19
Release  : 76
URL      : https://cran.r-project.org/src/contrib/digest_0.6.19.tar.gz
Source0  : https://cran.r-project.org/src/contrib/digest_0.6.19.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558352738
...
/usr/lib64/R/library/digest/tests/digest2intTest.R
